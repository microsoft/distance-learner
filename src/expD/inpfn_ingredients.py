...
def inpfn_config():
    ...
    SETTINGS.ENFORCE_KEYS_NO_EQUALS = False
    ...
    # settings_to_analyze = {
    #     "rdm_concspheres_k50n500_noninfdist_moreoffmfld_advtraindebug_eps=1e-1": ["1"],
    #     "rdm_concspheres_k50n500_noninfdist_moreoffmfld_advtraindebug_bs4096_eps=5e-2": ["1", "2"]
    # }
    settings_to_analyze = [
